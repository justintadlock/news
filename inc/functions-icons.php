 ...
 * @return string
 */
function news_get_font_icon_code( $name ) {

	$icons = news_get_font_icons();
 ...
 * @return string
 */
function news_get_font_icon_text( $name ) {

	$icon = news_get_font_icon_code( $name );
 ...
 * @return string
 */
function news_get_font_icon_html( $name ) {
 ...
 * @return string
 */
function news_get_font_icon_css( $name ) {
 ...
 * @return bool
 */
function news_font_icon_exists( $name ) {
 ...
 * @return string
 */
function news_validate_font_icon( $icon ) {

	return news_font_icon_exists( $icon ) ? $icon : '';
}
...
function news_get_font_icons() {
	...
	return apply_filters( 'news_font_icons', $icons );
}
